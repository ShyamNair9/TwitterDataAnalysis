...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">Popularity of Players</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
							...
							<div class="panel-heading">
                            From lower league ball boy to the talk of the town!
                        </div>
                        <div class="panel-body">
                            <p>Jamie Vardy, the former Fleetwood town player, is the most talked about player in the premier league at the moment ahead of even Rooney and Aguero. His success on the field has propelled Leicester City to the top of the Premier League</p>
							<p>The top scorer of the premier league, Harry Kane comprises 7% of the tweets, which is ahead of many others including De Bruyne, Rooney and Ozil, but is much lower than Jamie Vardy's proportion (42%).</p>                           
                        </div>
                        </div>                       
                    </div>
                </div>
