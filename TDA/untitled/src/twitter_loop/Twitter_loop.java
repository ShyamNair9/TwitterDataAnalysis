...
public class Twitter_loop {
    ...
    public void loadMenu() throws InterruptedException {
        ...
        while(i < 1)
        {
            ...
            cb.setOAuthConsumerKey("SHT8xrUwr2ldzWYx7cspO7OUD");
            cb.setOAuthConsumerSecret("TxSd5f8oeOAFFe3HU53DouQLo65f063icWCKZOPplqFQlXy5bv");
            cb.setOAuthAccessToken("4732644389-luPr0iQEOd6INFlig4WqdOpW55NBAxJVjOpy3dW");
            cb.setOAuthAccessTokenSecret("xMDoXPRv1gIUbmbMnR1xiYtliFrbqDAzJqG22wMv1oHYI");
    ...
    public void getTweetByQuery(boolean loadRecords, String keyword) throws InterruptedException {
        ...
        if (cb != null) {
            ...
            try {
                ...
                query.setCount(100);
                query.setLang("en");
                query.setSince("2015-08-07");
                query.setUntil("2015-08-8");
                QueryResult result;
